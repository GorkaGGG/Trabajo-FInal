...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 23-04-2026 a las 22:51:42
...
--
ALTER TABLE `piso`
  ADD CONSTRAINT `piso_ibfk_1` FOREIGN KEY (`NUM_PISO`) REFERENCES `habitacion` (`PISO`) ON DELETE CASCADE ON UPDATE CASCADE;
